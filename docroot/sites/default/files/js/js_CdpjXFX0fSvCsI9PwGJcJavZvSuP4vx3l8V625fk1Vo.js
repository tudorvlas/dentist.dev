...
//	console.log(window.innerWidth);
	if (window.innerWidth < 936) {
		...
		var main_nav_height = $('.main-nav').height();
		main_nav_height = main_nav_height - 31;
		$('.absolute_logo').css('top',main_nav_height);
	}
	else {
		$('.absolute_logo').css('top',8);
	}
}
...
//if ($(window).width() < 936) {
	...
	$('.main-nav').click(function() {
		...
		if (window.innerWidth < 936) {
			...
			main_nav_height = main_nav_height - 32;
		}
		$('.absolute_logo').css('top',main_nav_height);
//		alert ("toggle");
	});
...
/**Logo**/
if($(".wrapper.relative").height() > 295){
 	$(".absolute_logo").css('top', '250px');
	alert("ici");
}
// if($(".main-nav.responsive").height() > 291){
//  	$(".absolute_logo").css('top', '253px');
// }
//
...
/** Slider **/
	...
	$(function() {
		$('#fader li:not(:first)').hide();
		$('#fader li').css('position', 'absolute');
		$('#fader li').css('top', '0px');
		$('#fader li').css('left', '0');
		$('#fader li').each(function() {
			var li = $(this);
			$('<li>').attr('src', $(this).attr('src')).load(function() {
		...
		function fadeNext() {
			$('#fader li').first().fadeOut().appendTo($('#fader'));
			$('#fader li').first().fadeIn();
		}

		function fadePrev() {
			$('#fader li').first().fadeOut();
			$('#fader li').last().prependTo($('#fader')).fadeIn();
		}
